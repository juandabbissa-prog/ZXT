...
export class KeywordPersistenceError extends DatabaseError {
  constructor(
    public readonly kind: 'UNIQUE' | 'FOREIGN_KEY' | 'SERIALIZATION' | 'DEADLOCK' | 'UNKNOWN',
  ) {
    super('Keyword persistence operation failed.');
  }
}
