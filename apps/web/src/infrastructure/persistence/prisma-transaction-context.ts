...
export class InvalidPersistenceTransactionContextError extends Error {
  constructor() {
    super('Invalid persistence transaction context.');
    this.name = 'InvalidPersistenceTransactionContextError';
  }
}
export function createPrismaTransactionContext(
  client: Prisma.TransactionClient,
): PersistenceTransactionContext {
  const context = {} as PersistenceTransactionContext;
  contexts.set(context, client);
  return context;
}
