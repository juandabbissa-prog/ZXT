...
export type KeywordVariantRecord = Readonly<{
  id: string;
  keywordId: KeywordId;
  phrase: string;
  normalizedPhrase: string;
...
export type KeywordCategoryRecord = Readonly<{
  id: string;
  code: string;
  name: string;
...
export type KeywordTagRecord = Readonly<{
  id: string;
  code: string;
  name: string;
  status: ReferenceStatus;
...
export type CreateKeywordInput = Readonly<{
  phrase: string;
  normalizedPhrase: string;
  categoryId: string;
  source: KeywordSource;
...
export type UpdateKeywordInput = Readonly<{
